"".T.M1 STEXT nosplit size=1 args=0x18 locals=0x0 funcid=0x0 align=0x0
	0x0000 00000 (main.go:10)	TEXT	"".T.M1(SB), NOSPLIT|ABIInternal, $0-24
	...
	0x0000 00000 (main.go:10)	FUNCDATA	$5, "".T.M1.arginfo1(SB)
	0x0000 00000 (main.go:10)	RET
	0x0000 c3                                               .
"".T.M2 STEXT nosplit size=1 args=0x18 locals=0x0 funcid=0x0 align=0x0
	0x0000 00000 (main.go:11)	TEXT	"".T.M2(SB), NOSPLIT|ABIInternal, $0-24
	...
	0x0000 00000 (main.go:11)	FUNCDATA	$5, "".T.M2.arginfo1(SB)
	0x0000 00000 (main.go:11)	RET
	0x0000 c3                                               .
"".main STEXT size=146 args=0x0 locals=0x58 funcid=0x0 align=0x0
	0x0000 00000 (main.go:18)	TEXT	"".main(SB), ABIInternal, $88-0
	0x0000 00000 (main.go:18)	CMPQ	SP, 16(R14)
	0x0004 00004 (main.go:18)	PCDATA	$0, $-2
	0x0004 00004 (main.go:18)	JLS	136
	0x000a 00010 (main.go:18)	PCDATA	$0, $-1
	0x000a 00010 (main.go:18)	SUBQ	$88, SP
	0x000e 00014 (main.go:18)	MOVQ	BP, 80(SP)
	0x0013 00019 (main.go:18)	LEAQ	80(SP), BP
	0x0018 00024 (main.go:18)	FUNCDATA	$0, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x0018 00024 (main.go:18)	FUNCDATA	$1, gclocals·24b0aee1021c20d1590e75b99691b0e0(SB)
	0x0018 00024 (main.go:18)	FUNCDATA	$2, "".main.stkobj(SB)
	0x0018 00024 (main.go:27)	MOVQ	$17, ""..autotmp_7+56(SP)
	0x0021 00033 (main.go:27)	LEAQ	go.string."hello, interface"(SB), CX
	0x0028 00040 (main.go:27)	MOVQ	CX, ""..autotmp_7+64(SP)
	0x002d 00045 (main.go:27)	MOVQ	$16, ""..autotmp_7+72(SP)
	0x0036 00054 (main.go:27)	LEAQ	type."".T(SB), AX
	0x003d 00061 (main.go:27)	LEAQ	""..autotmp_7+56(SP), BX
	0x0042 00066 (main.go:27)	PCDATA	$1, $0
	0x0042 00066 (main.go:27)	CALL	runtime.convT(SB)
	0x0047 00071 (main.go:29)	MOVUPS	X15, ""..autotmp_12+40(SP)
	0x004d 00077 (main.go:29)	MOVQ	go.itab."".T,"".NonEmptyInterface+8(SB), CX
	0x0054 00084 (main.go:29)	MOVQ	CX, ""..autotmp_12+40(SP)
	0x0059 00089 (main.go:29)	MOVQ	AX, ""..autotmp_12+48(SP)
	0x005e 00094 (<unknown line number>)	NOP
	0x005e 00094 ($GOROOT/src/fmt/print.go:274)	MOVQ	os.Stdout(SB), BX
	0x0065 00101 ($GOROOT/src/fmt/print.go:274)	LEAQ	go.itab.*os.File,io.Writer(SB), AX
	0x006c 00108 ($GOROOT/src/fmt/print.go:274)	LEAQ	""..autotmp_12+40(SP), CX
	0x0071 00113 ($GOROOT/src/fmt/print.go:274)	MOVL	$1, DI
	0x0076 00118 ($GOROOT/src/fmt/print.go:274)	MOVQ	DI, SI
	0x0079 00121 ($GOROOT/src/fmt/print.go:274)	CALL	fmt.Fprintln(SB)
	0x007e 00126 (main.go:30)	MOVQ	80(SP), BP
	0x0083 00131 (main.go:30)	ADDQ	$88, SP
	0x0087 00135 (main.go:30)	RET
	0x0088 00136 (main.go:30)	NOP
	0x0088 00136 (main.go:18)	PCDATA	$1, $-1
	0x0088 00136 (main.go:18)	PCDATA	$0, $-2
	0x0088 00136 (main.go:18)	CALL	runtime.morestack_noctxt(SB)
	0x008d 00141 (main.go:18)	PCDATA	$0, $-1
	0x008d 00141 (main.go:18)	JMP	0
	0x0000 49 3b 66 10 0f 86 7e 00 00 00 48 83 ec 58 48 89  I;f...~...H..XH.
	0x0010 6c 24 50 48 8d 6c 24 50 48 c7 44 24 38 11 00 00  l$PH.l$PH.D$8...
	0x0020 00 48 8d 0d 00 00 00 00 48 89 4c 24 40 48 c7 44  .H......H.L$@H.D
	0x0030 24 48 10 00 00 00 48 8d 05 00 00 00 00 48 8d 5c  $H....H......H.\
	0x0040 24 38 e8 00 00 00 00 44 0f 11 7c 24 28 48 8b 0d  $8.....D..|$(H..
	0x0050 00 00 00 00 48 89 4c 24 28 48 89 44 24 30 48 8b  ....H.L$(H.D$0H.
	0x0060 1d 00 00 00 00 48 8d 05 00 00 00 00 48 8d 4c 24  .....H......H.L$
	0x0070 28 bf 01 00 00 00 48 89 fe e8 00 00 00 00 48 8b  (.....H.......H.
	0x0080 6c 24 50 48 83 c4 58 c3 e8 00 00 00 00 e9 6e ff  l$PH..X.......n.
	0x0090 ff ff                                            ..
	rel 4+0 t=23 type."".T+0
	rel 4+0 t=23 type.*os.File+0
	rel 36+4 t=14 go.string."hello, interface"+0
	rel 57+4 t=14 type."".T+0
	rel 67+4 t=7 runtime.convT+0
	rel 80+4 t=14 go.itab."".T,"".NonEmptyInterface+8
	rel 97+4 t=14 os.Stdout+0
	rel 104+4 t=14 go.itab.*os.File,io.Writer+0
	rel 122+4 t=7 fmt.Fprintln+0
	rel 137+4 t=7 runtime.morestack_noctxt+0
...
go.info."".T.M1$abstract SDWARFABSFCN dupok size=10
	0x0000 05 2e 54 2e 4d 31 00 01 01 00                    ..T.M1....
go.info."".T.M2$abstract SDWARFABSFCN dupok size=10
	0x0000 05 2e 54 2e 4d 32 00 01 01 00                    ..T.M2....
...
"".T.M2.arginfo1 SRODATA static dupok size=11
	0x0000 fe 00 08 fe 08 08 10 08 fd fd ff                 ...........
gclocals·24b0aee1021c20d1590e75b99691b0e0 SRODATA dupok size=9
	0x0000 01 00 00 00 05 00 00 00 00                       .........
"".main.stkobj SRODATA static size=40
	0x0000 02 00 00 00 00 00 00 00 d8 ff ff ff 10 00 00 00  ................
